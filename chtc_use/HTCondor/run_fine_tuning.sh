...
run_cmd "python HAVEN/src/run.py -c HAVEN/input/config-files/virus_host_prediction/influenza-fine-tuning.yaml"
...
run_cmd "mv fine_tuning_accuracy.tar.gz /staging/aranastasi/HAVEN/outputs/influenza/"
