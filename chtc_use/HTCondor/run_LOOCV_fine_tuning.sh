...
run_cmd "mkdir -p /staging/aranastasi/HAVEN/outputs/LOOCV_without_validation_reps"

run_cmd "mv kuzmin_LOOCV_fine_tuning_rep$rep.tar.gz /staging/aranastasi/HAVEN/outputs/LOOCV_without_validation_reps"
