...
from pipelines.virus_host_prediction_training import fine_tuning_pipeline, fine_tuning_external_pipeline, kuzmin_fine_tuning_pipeline, baseline_deep_learning_pipeline, baseline_machine_learning_pipeline, TEST_kuzmin_fine_tuning_pipeline
...
pipeline_mapper = {
    ...
    "TEST_virus_host_prediction_kuzmin": TEST_kuzmin_fine_tuning_pipeline,
